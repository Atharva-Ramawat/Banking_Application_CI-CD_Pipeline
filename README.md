...
[**Live Preview**](https://bank.apurvanand.com) | [**Swagger Documentation**](https://api.apurvanand.com/documentation) | [**Contact the developer**](mailto:contact@apurvanand.com)
...
<div align="center">
    <img src="https://images.apurvanand.com/app_dashboard.png"  />
</div>

<hr>

<dl>
  <h3>Frontend technologies stack (<a href="https://github.com/apurvanand/bank-client"><strong>client</strong></a>)</h3>
  ...
  <h3>Backend technologies stack (<a href="https://github.com/apurvanand/bank-server"><strong>server</strong></a>)</h3>
...
git clone https://github.com/apurvanand/bank
...
<h4>License</h4>
This project is licensed under the MIT license. Copyright (c) 2019-2020 Apurv Anand.
