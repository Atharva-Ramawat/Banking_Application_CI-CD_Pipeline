...
export class BillSubscriber implements EntitySubscriberInterface<BillEntity> {
  ...
  private readonly _messageOptions = {
    en: {
      ...
      actions: [
        `<a href="mailto:contact@apurvanand.com">I want to send you feedback now</a>`,
    ...
    de: {
      ...
      actions: [
        `<a href="mailto:contact@apurvanand.com">Ich möchte Ihnen jetzt eine Meinung senden</a>`,
    ...
    pl: {
      ...
      actions: [
        `<a href="mailto:contact@apurvanand.com">Chcę przesłać opinię teraz</a>`,
